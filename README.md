...
1. **Установка приложения и RabbitMQ через Helm:**
   ```bash
   helm install rabbitmq oci://registry-1.docker.io/bitnamicharts/rabbitmq -n logging
   helm install orderservice ./helm/elk-chart -n otus-msa
   ```
2. **Проверка писем нотификации:**
